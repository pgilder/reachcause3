...
// COPY CONTENT
// 'Modern' browsers (IE8+, use CSS-style selectors)
document.querySelector('.product').innerHTML = 'safe shelter';

// Using the jQuery library
$('.product').html('safe shelter');

// 'Modern' browsers (IE8+, use CSS-style selectors)
document.querySelector('.producttype').innerHTML = 'safety';

// Using the jQuery library
$('.producttype').html('safety');
...
// 'Modern' browsers (IE8+, use CSS-style selectors)
document.querySelector('.recipientshort').innerHTML = 'animal';

// Using the jQuery library
$('.recipientshort').html('animal');
